...
public class H7G5FolderModelImpl
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"createDate", H7G5Folder::getCreateDate);
			attributeGetterFunctions.put(
				"modifiedDate", H7G5Folder::getModifiedDate);
			attributeGetterFunctions.put(
				"description", H7G5Folder::getDescription);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"groupId",
				(BiConsumer<H7G5Folder, Long>)H7G5Folder::setGroupId);
			attributeSetterBiConsumers.put(
				"companyId",
	...
	public <T> T getColumnValue(String columnName) {
		Function<H7G5Folder, Object> function =
