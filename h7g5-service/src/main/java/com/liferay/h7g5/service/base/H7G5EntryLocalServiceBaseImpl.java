...
public abstract class H7G5EntryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>H7G5EntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.h7g5.service.H7G5EntryLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return h7g5EntryPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement H7G5EntryLocalServiceImpl#deleteH7G5Entry(H7G5Entry) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		H7G5EntryLocalServiceBaseImpl.class);
